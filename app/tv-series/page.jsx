...
const yearRanges = {
    2026: { gte: "2026-01-01", lte: "2026-12-31" },
...
export default function TvSeriesPage() {
    ...
    //use SWR to fetch and cache the tv series data
    const { data: seriesData, isLoading } = useSWR(apiUrl.toString(), fetcher)
    ...
    //- filter section - step 7: add a helper function to manually filter tv series in search mode (becuz TMDB search endpoint doesnt support filter params)
    ...
    const filteredSeries = useMemo(() => {
        ...
        return query ? filterSeries(seriesData.results, { genre, yearRange, rating, language }) : seriesData.results
    ...
    return (
        ...
        >
            ...
            {/* show the pagination only if there are enough results - update pagination to reflect filterseries length*/}
