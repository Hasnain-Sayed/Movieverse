...
const { data: moviesData, isLoading } = useSWR(apiUrl.toString(), fetcher)
...
//- filter section - step 7: add a helper function to manually filter movies in search mode (becuz TMDB search endpoint doesnt support filter params)
...
const filteredMovies = useMemo(() => {
    ...
    return query ? filterMovies(moviesData.results,{genre,yearRange,rating,language}) : moviesData.results 
